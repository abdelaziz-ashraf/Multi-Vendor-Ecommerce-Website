...
{{--                        <li><a href="#"><i class="fas fa-star"></i> hot promotions</a></li>--}}
                        ...
                        @foreach($categories as $category)
                            <li><a class="{{ count($category->subCategories) ? 'wsus__droap_arrow' : '' }}" href="#"> {{ $category->name }} </a>
                                @if(count($category->subCategories))
                                    <ul class="wsus_menu_cat_droapdown">
                                        @foreach($category->subCategories as $sub_category)
                                            <li><a href="#">{{ $sub_category->name }} @if(count($sub_category->childCategories)) <i class="fas fa-angle-right"></i> @endif</a>
                                                @if(count($sub_category->childCategories))
                    ...
                    <ul class="wsus__menu_item wsus__menu_item_right">
                        ...
                        <li><a href="{{ route('login') }}">login/regiser</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="wsus__mobile_menu_main_menu">
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <ul class="wsus_mobile_menu_category">
                        ...
                        @foreach($categories as $category)
                            <li>
                                <a href="#" class="{{count($category->subCategories) ? 'accordion-button' : '' }} collapsed" data-bs-toggle="collapse"
                                   data-bs-target="#flush-collapseThreew-{{$loop->index}}" aria-expanded="false"
                                   aria-controls="flush-collapseThreew-{{$loop->index}}"><i class="fal fa-tshirt"></i>
                                    {{ $category->name }}</a>
                                @if(count($category->subCategories))
