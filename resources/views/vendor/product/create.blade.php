...
@section('content')
    ...
    <div class="col-xl-9 col-xxl-10 col-lg-9 ms-auto">
        <div class="dashboard_content mt-2 mt-md-0">
            <h3><i class="far fa-user"></i>Create New Product</h3>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group wsus__add_address_single">
                                                            ...
                                                            <input type="text" class="form-control" name="sku"
                                                                   value="{{ old('sku') }}" placeholder="Write SKU">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group wsus__add_address_single">
                                                            ...
                                                            <input type="number" min="0" class="form-control" name="quantity"
                                                                   value="{{ old('quantity') }}" placeholder="Add Quantity">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group wsus__add_address_single">
                                                ...
                                                <div class="wsus__add_address_single">
                                                    ...
                                                    <textarea cols="3" rows="5" placeholder="Type Description" name="description">{{ old('description') }}</textarea>
                                                </div>

                                                <div class="form-group wsus__add_address_single">
                                                    <label>Seo Title</label>
                                                    <input type="text" class="form-control" name="seo_title"
                                                           value="{{ old('seo_title') }}" placeholder="Write SEO Title">
                                                </div>

                                                <div class="wsus__add_address_single">
                                                    <label>SEO Description</label>
                                                    <textarea cols="3" rows="5" placeholder="Type SEO Description" name="seo_description">{{ old('seo_description') }}</textarea>
                                                </div>
