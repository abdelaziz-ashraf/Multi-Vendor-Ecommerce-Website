                        ...
                        <section class="section">
                            <div class="section-body">
                                <div class="col-12">
                                    ...
                                    <form action="{{ route('vendor.product-variant-item.store', [
                                        'product' => $product, 'variant' => $variant]) }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group wsus__add_address_single">
                                                    ...
                                                    <input type="text" class="form-control" name="name"
                                                           value="{{ old('name') }}" placeholder="Write Item Name">
                                                </div>

                                                <div class="form-group wsus__add_address_single">
                                                    <label>Price</label>
                                                    <input type="text" class="form-control" name="price"
                                                           value="{{ old('price') }}" placeholder="Write Price (0 means free)">
                                                </div>
